                ...
                {order.productDetails && [...order.productDetails]
                    ...
                    .map((productDetail, index) => (
                        <Tr key={index} borderBottom="1px" borderColor="gray.400">
                            <Td borderBottom="1px" borderColor="gray.400">{productDetail.product ? productDetail.product.name : '--'}</Td>
                            <Td borderBottom="1px" borderColor="gray.400">{productDetail.product ? productDetail.product.activeIngredient : '--'}</Td>
