    ...
    return (
        <Modal isOpen={!!selectedOrder} onClose={onClose} size="full">
            ...
            {selectedMeasurement && selectedOrder && <ModalContent borderRadius="none" h="full">
                <ModalHeader>{t('recipe_in_progress_tkw_details_input_modal.count_tkw_treated')}</ModalHeader>
                <ModalCloseButton />
                    ...
                    {!isPhotoState ? (
                        <Grid templateColumns={"3fr 2fr"} gap={4} w='full'>
                            ...
                            <GridItem h={10} alignContent={'center'}>
                                <Text fontSize={{ base: "sm", md: "md" }}><strong>{t('recipe_in_progress_tkw_details_input_modal.lot')}:</strong></Text>
                            </GridItem>
                            <GridItem h={10} alignContent={'center'}>
                            ...
                            <GridItem h={10} alignContent={'center'}>
                                <Text fontSize={{ base: "sm", md: "md" }}><strong>{t('recipe_in_progress_tkw_details_input_modal.assignment_created_at')}:</strong></Text>
                            </GridItem>
                            <GridItem h={10} alignContent={'center'}>
                            ...
                            <GridItem h={10} alignContent={'center'}>
                                <Text fontSize={{ base: "sm", md: "md" }}><strong>{t('recipe_in_progress_tkw_details_input_modal.tkw_probe_1')}:</strong></Text>
                            </GridItem>
                            <GridItem h={10} alignContent={'center'}>
                                <HStack>
                                    <NumberInput
                            ...
                            <GridItem h={10} alignContent={'center'}>
                                <Text fontSize={{ base: "sm", md: "md" }}><strong>{t('recipe_in_progress_tkw_details_input_modal.tkw_probe_2')}:</strong></Text>
                            </GridItem>
                            <GridItem h={10} alignContent={'center'}>
                                <HStack>
                                    <NumberInput
                            ...
                            <GridItem h={10} alignContent={'center'}>
                                <Text fontSize={{ base: "sm", md: "md" }}><strong>{t('recipe_in_progress_tkw_details_input_modal.tkw_probe_3')}:</strong></Text>
                            </GridItem>
                            <GridItem h={10} alignContent={'center'}>
                                <HStack>
                                    <NumberInput
                            ...
                            <GridItem h={10} alignContent={'center'}>
                                <Text fontSize={{ base: "sm", md: "md" }}><strong>{t('recipe_in_progress_tkw_details_input_modal.average_tkw')}:</strong></Text>
                            </GridItem>
                            <GridItem h={10} alignContent={'center'}>
                        ...
                        <VStack spacing={8} width="100%">
                            <Text mb={1} fontSize={{ base: "sm", md: "md" }} fontWeight="bold">
                                {t('recipe_in_progress_tkw_details_input_modal.take_photo_treated')} {selectedOrder.crop.name} {selectedOrder.lotNumber}
                            </Text>
                            <Box
                                width="100%"
                                maxWidth="400px"
                            ...
                            <VStack spacing={4} width="100%">
                                <Button
                                    ...
                                    disabled={isSaving}
                                >
                                    {tkwProbesPhoto ? t('recipe_in_progress_tkw_details_input_modal.retake_picture') : t('recipe_in_progress_tkw_details_input_modal.take_picture')}
                                </Button>
                            </VStack>
                        </VStack>
                    )}
                    ...
                    <VStack align="start" w="full">
                        {!isPhotoState && (
                            <Checkbox
                                ...
                                disabled={isSaving}
                            >
                                {t('recipe_in_progress_tkw_details_input_modal.confirm_tkw_compliance')}
                            </Checkbox>
                        )}
                        <HStack w="full" justify="end">
                            <Button variant="ghost" mb="3" onClick={handleBack} disabled={isSaving}>{t('recipe_in_progress_tkw_details_input_modal.back')}</Button>
                            {!isPhotoState ? (
                                <Button colorScheme="blue" mb="3" onClick={handleNext} isDisabled={!isConfirmed || averageTkw === null || isSaving}>
                                    {t('recipe_in_progress_tkw_details_input_modal.next')}
                                </Button>
                            ) : (
                                <Button colorScheme="blue" mb="3" onClick={handleSave} isDisabled={!tkwProbesPhoto || isSaving}>
                                    {isSaving ? <CircularProgress isIndeterminate size="24px" color='blue.300' /> : t('recipe_in_progress_tkw_details_input_modal.save')}
                                </Button>
                            )}
                        </HStack>
                    </VStack>
